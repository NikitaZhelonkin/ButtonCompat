...
public class ImageButtonCompat extends AppCompatImageButton {
    ...
    public ImageButtonCompat(Context context) {
        super(context);
        init(null, 0);
    }

    public ImageButtonCompat(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public ImageButtonCompat(Context context, AttributeSet attrs, int defStyleAttr) {
