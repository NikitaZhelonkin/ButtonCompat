...
class ShadowDrawable extends Drawable {
    ...
    public ShadowDrawable(Resources resources, float inset, float radius,
                          float shadowSize, float maxShadowSize) {
        mInset = inset;
        mShadowStartColor = resources.getColor(R.color.button_compat_shadow_start_color);
        mShadowEndColor = resources.getColor(R.color.button_compat_shadow_end_color);
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.translate(0, mRawMaxShadowSize / 2);
        drawShadow(canvas);
    ...
    private void buildComponents(Rect bounds) {
        ...
        final float verticalInset = mInset;
